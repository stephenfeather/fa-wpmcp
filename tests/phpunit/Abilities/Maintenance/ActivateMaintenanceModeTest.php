...
final class ActivateMaintenanceModeTest extends BrainMonkeyTestCase
{
    ...
    {
        return new ActivateMaintenanceMode();
    }

    protected function getExpectedMetadata(): array
    {
        return array(
            'name'                  => 'fa-wpmcp/activate-maintenance-mode',
            'category'              => 'maintenance',
            'label'                 => 'Activate Maintenance Mode',
            'description_contains'  => 'activate',
